...
```{bash, eval=FALSE}
python filter.py -f1 ../Input/gProfiler_hsapiens_10-19-2023_8-37-11\ PM.csv -f2 ../Input/bulk-gex_v8_rna-seq_GTEx_Analysis_2017-06-05_v8_RNASeQCv1.1.9_gene_reads.gct -o ../Input/GTEx_SLCs_gene_reads.gct
```
